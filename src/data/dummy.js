...
import { AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineStock, AiFillHome, AiFillBank } from 'react-icons/ai';
import { FiBarChart, FiCreditCard, FiStar, FiShoppingCart, FiUsers } from 'react-icons/fi';
import { BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsFillLayersFill, BsFillMenuButtonWideFill, BsFillPersonFill, BsMessenger } from 'react-icons/bs';
...
// export const actionUpdate = (props) => {
//   <button type></button>
// }


export const gridDate = (props) => {
  console.log(props.create_date);
  <div>{Date.parse(props.create_date.toString())}</div>
}
